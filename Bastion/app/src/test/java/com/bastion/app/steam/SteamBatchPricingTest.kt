...
import com.bastion.app.steam.market.SteamBatchPriceMode
import com.bastion.app.steam.market.SteamBatchPricing
...
class SteamBatchPricingTest {
    ...
    fun supportsHistoryExtremesAndManualReceive() {
        ...
        assertEquals(1083, com.bastion.app.steam.market.SteamMarketFees(wallet).buyerPays(recentHigh!!))
        assertEquals(383, com.bastion.app.steam.market.SteamMarketFees(wallet).buyerPays(recentLow!!))
        assertEquals(
            321,
            SteamBatchPricing.resolveSellerReceive(
