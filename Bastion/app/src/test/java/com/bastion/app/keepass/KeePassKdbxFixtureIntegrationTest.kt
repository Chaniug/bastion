...
import com.bastion.app.utils.KeePassRawStringField
import com.bastion.app.utils.KeePassCodecSupport
import com.bastion.app.utils.extractKeePassCustomFieldsForPasswordEntry
...
class KeePassKdbxFixtureIntegrationTest {
    ...
    fun kdbxRoundTripPreservesOtpUnknownPluginAttachmentHistoryAndMetadataAfterPatch() {
        ...
        val originalDatabase = KeePassDatabase.Ver4x.create(
            rootName = "Root",
            meta = Meta(generator = "Bastion fixture", name = "G02 fixture"),
    ...
    fun groupTreeChangeSetCreatesAndDeletesSubtreeWithHistoryCustomDataAndTimes() {
        ...
        val baseDatabase = KeePassDatabase.Ver4x.create(
            rootName = "Root",
            meta = Meta(generator = "Bastion fixture", name = "Group tree fixture"),
            credentials = credentials
        ).modifyParentGroup {
    ...
    private fun fixturePasskeyEntry(entryUuid: UUID): Entry {
        ...
        return Entry(
            ...
            fields = EntryFields.of(
                ...
                "BastionkeyCredentialId" to EntryValue.Plain("legacy-bastion-credential"),
                "BastionkeyMode" to EntryValue.Plain("KEEPASS_COMPAT"),
                "BastionkeyData" to EntryValue.Encrypted(EncryptedValue.fromString("""{"credentialId":"legacy-bastion-credential"}""")),
                ...
                "KPEX_PASSKEY_CREDENTIAL_ID" to EntryValue.Encrypted(EncryptedValue.fromString("legacy-bastion-credential")),
    ...
    private fun assertFixturePasskeyEntryPreserved(entry: Entry) {
        ...
        assertEquals("legacy-bastion-credential", entry.fields.getValue("BastionkeyCredentialId").content)
        assertEquals("KEEPASS_COMPAT", entry.fields.getValue("BastionkeyMode").content)
        assertEquals("""{"credentialId":"legacy-bastion-credential"}""", entry.fields.getValue("BastionkeyData").content)
        ...
        assertEquals("legacy-bastion-credential", entry.fields.getValue("KPEX_PASSKEY_CREDENTIAL_ID").content)
