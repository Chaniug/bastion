...
class WebDavBillingAddressBackupGuardTest {
    ...
    fun webDavBackupAndRestoreKeepBillingAddressesInCardWalletBackup() {
        ...
        assertTrue(source.contains("deleteAllLocalItemsByType(com.bastion.app.data.ItemType.BILLING_ADDRESS)"))
    ...
    fun webDavBackupAndRestoreKeepPaymentAccountsInCardWalletBackup() {
        ...
        assertTrue(source.contains("deleteAllLocalItemsByType(com.bastion.app.data.ItemType.PAYMENT_ACCOUNT)"))
