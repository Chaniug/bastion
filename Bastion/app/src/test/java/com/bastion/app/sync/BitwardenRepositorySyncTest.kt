...
import com.bastion.app.bitwarden.sync.BitwardenCoordinatedSyncResult
...
import com.bastion.app.bitwarden.sync.mergeBitwardenSyncStatuses
import com.bastion.app.bitwarden.sync.toBitwardenBlockReason
import com.bastion.app.bitwarden.sync.toRepositorySyncResultForUi
...
class BitwardenRepositorySyncTest {
    ...
    fun legacySendRefreshApiStaysDeprecatedBecauseItBypassesCoordinator() {
        ...
        val repositorySyncSource = projectFile(
            "app/src/main/java/com/bastion/app/bitwarden/sync/BitwardenRepositorySync.kt"
        ).readText()
    ...
    fun bitwardenFallbackWorkerDoesNotReplaceRunningMutationSyncWork() {
        val workerSource = projectFile(
            "app/src/main/java/com/bastion/app/bitwarden/sync/BitwardenSyncWorker.kt"
        ).readText()
