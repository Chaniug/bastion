...
class KeePassAttachmentExecutorRegressionGuardTest {
    ...
    fun keepassAttachmentOperationsDoNotRequireWarmServiceCache() {
        val source = projectFile(
            "app/src/main/java/com/bastion/app/attachments/executor/KeePassAttachmentExecutor.kt"
        ).readText()
        ...
        val attachmentContainer = projectFile(
            "app/src/main/java/com/bastion/app/attachments/AttachmentContainer.kt"
        ).readText()
        assertTrue(
    ...
    fun pendingDraftsCanFlushToKeePassAfterNewEntryIsSaved() {
        val editSection = projectFile(
            "app/src/main/java/com/bastion/app/attachments/ui/AttachmentsEditSection.kt"
        ).readText()
        assertTrue(
