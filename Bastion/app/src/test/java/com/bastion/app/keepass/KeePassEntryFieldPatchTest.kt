    ...
    fun passkeyPatchReplacesCompatFieldsAndPreservesExternalUnknownFields() {
        val entry = Entry(
            ...
            fields = EntryFields.of(
                ...
                "BastionkeyData" to EntryValue.Encrypted(EncryptedValue.fromString("old-json")),
        ...
        val replacementFields = EntryFields.of(
            ...
            "BastionkeyData" to EntryValue.Encrypted(EncryptedValue.fromString("new-json")),
        ...
        assertEquals("new-json", patched.fields.getValue("BastionkeyData").content)
