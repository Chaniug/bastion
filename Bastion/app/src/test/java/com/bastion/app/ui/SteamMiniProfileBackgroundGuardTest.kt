...
class SteamMiniProfileBackgroundGuardTest {
    ...
    fun featureIsOffByDefaultAndWiredThroughExtensions() {
        val appSettings = projectFile(
            "app/src/main/java/com/bastion/app/data/AppSettings.kt"
        ).readText()
        val settingsManager = projectFile(
            "app/src/main/java/com/bastion/app/utils/SettingsManager.kt"
        ).readText()
        val extensions = projectFile(
            "app/src/main/java/com/bastion/app/ui/screens/ExtensionsScreen.kt"
        ).readText()
    ...
    fun dynamicPlaybackIsBoundedSilentAndLifecycleAware() {
        val layer = projectFile(
            "app/src/main/java/com/bastion/app/steam/ui/SteamMiniProfileBackgroundLayer.kt"
        ).readText()
    ...
    fun diskCacheKeepsItsHardLimits() {
        val cache = projectFile(
            "app/src/main/java/com/bastion/app/steam/profile/SteamMiniProfileBackground.kt"
        ).readText()
