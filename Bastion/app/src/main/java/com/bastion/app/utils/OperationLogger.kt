...
import com.bastion.app.data.OperationType
import com.bastion.app.data.PasswordDatabase
import com.bastion.app.data.TimelineVersionSnapshot
import com.bastion.app.data.timelineSnapshotCutoff
...
object OperationLogger {
    ...
    private suspend fun persistEncryptedVersionSnapshot(
        ...
        if (!com.bastion.app.data.areTimelineSnapshotFieldsReversible(
