...
internal fun PasswordManualStackGroup(
    ...
    unmatchedIconHandlingStrategy: com.bastion.app.data.UnmatchedIconHandlingStrategy,
    passwordCardDisplayMode: com.bastion.app.data.PasswordCardDisplayMode,
    passwordCardDisplayFields: List<com.bastion.app.data.PasswordCardDisplayField>,
