...
object MdbxDiagLogger {
    ...
    private const val TAG = "BastionMDBX"
    ...
    private val writeExecutor = BoundedLogExecutorFactory.createSingleThreadExecutor("bastion-mdbx-diag")
    @Volatile
        ...
        synchronized(fileLock) {
            ...
            runCatchingObserved {
                ...
                val header = buildString {
                    appendLine("=== Bastion MDBX Diag Session ===")
