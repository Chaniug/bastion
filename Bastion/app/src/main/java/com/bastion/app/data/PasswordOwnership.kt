...
sealed class PasswordOwnership {
    object BastionLocal : PasswordOwnership()
...
fun PasswordEntry.resolveOwnership(): PasswordOwnership {
    ...
    return when {
        hasKeePassBinding && hasBitwardenBinding -> when {
            ...
            !hasConcreteKeePassBinding && !hasConcreteBitwardenBinding -> PasswordOwnership.BastionLocal
        ...
        hasBitwardenBinding -> if (hasConcreteBitwardenBinding) {
            ...
            PasswordOwnership.BastionLocal
        }

        else -> PasswordOwnership.BastionLocal
    }
}
