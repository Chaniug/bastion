...
import com.bastion.app.repository.MdbxStructureNode
import com.bastion.app.repository.MdbxStructureNodeStatus
import com.bastion.app.repository.MdbxStructureNodeType
    ...
    LazyColumn(
        ...
        item {
            MdbxManagerEntryCard(
                ...
                title = "本地 MDBX 管理",
                subtitle = "管理 Bastion 私有目录和系统文件中的 .mdbx 数据库",
                count = localCount,
                color = MaterialTheme.colorScheme.primary,
                onClick = onOpenLocal
            )
...
private fun mdbxSourceLabel(database: LocalMdbxDatabase): String =
    when (database.sourceTypeEnum) {
        MdbxSourceType.LOCAL_INTERNAL -> "Bastion 私有目录"
