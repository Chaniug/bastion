...
import com.bastion.app.util.AegisDecryptor
...
class DataExportImportManager(private val context: Context) {
    ...
    data class ExportItem(
        ...
        /** true 表示来自 Bastion 自身导出的 CSV，导入时应跳过重复检测直接恢复 */
    ...
    private fun detectCsvFormat(firstLine: String): CsvFormat {
        ...
        return when {
            ...
            // Bastion 应用自身导出格式：ID,Type,Title,Data,Notes,...
...
/**
    ...
    /**
     * Base32编码（用于将Base64密钥转换为TOTP标准的Base32格式）
     */
