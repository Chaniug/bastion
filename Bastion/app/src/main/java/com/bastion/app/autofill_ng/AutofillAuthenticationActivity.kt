...
private fun PasswordVerificationCard(
    ...
    androidx.compose.material3.Card(
        ...
        Column(
            ...
            com.bastion.app.ui.components.MasterPasswordTextField(
                value = password,
                onValueChange = { input ->
                    password = input
                    errorMessage = null
            ...
            Button(
                onClick = {
                    when {
                        com.bastion.app.security.MasterPasswordPolicy.isEmpty(password) -> errorMessage = emptyError
                        !com.bastion.app.security.MasterPasswordPolicy.meetsMinLength(password) -> errorMessage = minLengthError
