...
fun importTypeOptions(): List<ImportTypeInfo> {
    return listOf(
        ImportTypeInfo(
            ...
            title = stringResource(R.string.import_type_bastion_backup_title),
            description = stringResource(R.string.import_type_bastion_backup_desc),
            fileHint = stringResource(R.string.import_type_bastion_backup_file_hint)
        ),
        ImportTypeInfo(
            key = "kdbx",
...
fun csvImportTypeOptions(): List<ImportTypeInfo> {
    return listOf(
        ImportTypeInfo(
            key = "normal",
            icon = Icons.Default.TableChart,
            title = stringResource(R.string.import_type_csv_bastion_title),
            description = stringResource(R.string.import_type_csv_bastion_desc),
            fileHint = stringResource(R.string.import_type_csv_bastion_file_hint)
        ),
        ImportTypeInfo(
            key = "keepass_csv",
            icon = Icons.Default.Description,
