package com.bastion.app.workers
...
import com.bastion.app.webdav.WebDavErrorClassifier
import com.bastion.app.webdav.WebDavErrorKind
...
class AutoBackupWorker(
    ...
    private suspend fun runBackup(
        ...
        try {
            ...
            val securityManager = com.bastion.app.security.SecurityManager(applicationContext)
            ...
            android.util.Log.d(
                TAG,
                "Creating Bastion-local backup with ${passwords.size} passwords and ${secureItems.size} secure items"
            )
