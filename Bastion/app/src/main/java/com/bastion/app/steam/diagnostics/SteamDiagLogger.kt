...
import com.bastion.app.utils.BoundedLogExecutorFactory
...
object SteamDiagLogger {
    private const val TAG = "BastionSteamDiag"
    ...
    private val writeExecutor = BoundedLogExecutorFactory.createSingleThreadExecutor("bastion-steam-diag")
        ...
        synchronized(fileLock) {
            ...
            runCatchingObserved {
                ...
                val header = buildString {
                    appendLine("=== Bastion Steam Diag Session ===")
