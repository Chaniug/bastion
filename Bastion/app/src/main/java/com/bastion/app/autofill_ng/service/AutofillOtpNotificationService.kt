...
class AutofillOtpNotificationService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.bastion.app.autofill_ng.ACTION_START_OTP_NOTIF"
        const val ACTION_COPY = "com.bastion.app.autofill_ng.ACTION_COPY_OTP_NOTIF"
        const val ACTION_DISMISS = "com.bastion.app.autofill_ng.ACTION_DISMISS_OTP_NOTIF"
