...
@Composable
fun BastionExpressiveFilterChip(
    selected: Boolean,
    onClick: () -> Unit,
    label: String,
    ...
    if (animated) {
        ...
        val cornerRadius by animateDpAsState(
            ...
            label = "bastionExpressiveFilterChipCornerRadius"
        )
        val containerColor by animateColorAsState(
            ...
            label = "bastionExpressiveFilterChipContainer"
        )
        val contentColor by animateColorAsState(
            ...
            label = "bastionExpressiveFilterChipContent"
        )
        val borderColor by animateColorAsState(
            ...
            label = "bastionExpressiveFilterChipBorder"
        )
        val borderWidth by animateDpAsState(
            ...
            label = "bastionExpressiveFilterChipBorderWidth"
        )
        ...
        FilterChip(
            ...
            label = {
                BastionExpressiveFilterChipLabel(
                    label = label,
...
@Composable
private fun BastionExpressiveFilterChipLabel(
    label: String,
