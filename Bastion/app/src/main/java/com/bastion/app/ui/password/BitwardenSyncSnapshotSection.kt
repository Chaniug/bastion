...
import com.bastion.app.viewmodel.BitwardenSyncSnapshotFieldGroupPreview
            ...
            Row(
                ...
                Row {
                    IconButton(onClick = onToggle) {
                        Icon(
                            imageVector = if (isVisible) BastionIcons.Security.visibilityOff else BastionIcons.Security.visibility,
