...
data class KeePassEntryProjection(
    ...
    val bastionOwnedFields: Map<String, KeePassEntryFieldSnapshot>,
    ...
    companion object {
        fun fromSnapshot(snapshot: KeePassEntrySnapshot): KeePassEntryProjection {
            return KeePassEntryProjection(
                ...
                bastionOwnedFields = snapshot.fields.filterValues { KeePassFieldRegistry.isBastionOwned(it.name) },
