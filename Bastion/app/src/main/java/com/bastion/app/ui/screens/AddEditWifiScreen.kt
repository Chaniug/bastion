...
import com.bastion.app.data.model.WifiData
import com.bastion.app.data.model.WifiIp
import com.bastion.app.data.model.WifiProxy
import com.bastion.app.data.model.WifiSecurity
...
import com.bastion.app.utils.WifiQrParser
...
fun AddEditWifiScreen(
    ...
    val getBitwardenFolders: (Long) -> kotlinx.coroutines.flow.Flow<List<com.bastion.app.data.bitwarden.BitwardenFolder>> =
        remember(bitwardenFolderDao) {
            { vaultId -> bitwardenFolderDao.getFoldersByVaultFlow(vaultId) }
        }
    val getKeePassGroups: (Long) -> kotlinx.coroutines.flow.Flow<List<com.bastion.app.utils.KeePassGroupInfo>> =
    ...
    // 自定义字段状态
    val customFields = remember { mutableStateListOf<com.bastion.app.data.CustomFieldDraft>() }
    ...
    LaunchedEffect(passwordId) {
        ...
        customFields.clear()
        customFields.addAll(existing.map { com.bastion.app.data.CustomFieldDraft.fromCustomField(it) })
    }
...
private fun WifiFormBody(
    ...
    bitwardenFolderDao: com.bastion.app.data.bitwarden.BitwardenFolderDao,
    isEditing: Boolean,
    onAddTarget: () -> Unit,
    ...
    customFields: List<com.bastion.app.data.CustomFieldDraft>,
    onCustomFieldsChange: (List<com.bastion.app.data.CustomFieldDraft>) -> Unit
) {
    ...
    Column(
                    ...
                    OutlinedTextField(
                        ...
                        trailingIcon = {
                            Row {
                                ...
                                IconButton(onClick = {
                                    val gen = com.bastion.app.utils.PasswordGenerator()
        ...
        // 自定义字段区域（与密码页一致）
        com.bastion.app.ui.components.CustomFieldSectionHeader(
            onAddClick = {
                onCustomFieldsChange(
                    customFields + com.bastion.app.data.CustomFieldDraft(
                        id = com.bastion.app.data.CustomFieldDraft.nextTempId(),
                        title = "",
                        value = "",
                        isProtected = false,
                        isPreset = false,
        ...
        customFields.forEachIndexed { index, field ->
            com.bastion.app.ui.components.CustomFieldEditCard(
                index = index,
                field = field,
