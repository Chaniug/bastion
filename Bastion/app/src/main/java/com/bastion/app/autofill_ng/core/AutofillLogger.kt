...
object AutofillLogger {
    ...
    private const val TAG = "BastionAutofill"
    ...
    private val writeExecutor = BoundedLogExecutorFactory.createSingleThreadExecutor("bastion-autofill-log")
    @Volatile
    ...
    fun exportLogs(maxEntries: Int = 500): String {
        return synchronized(logs) {
            ...
            buildString {
                appendLine("=== Bastion Autofill 诊断日志 ===")
