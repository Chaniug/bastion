...
import com.bastion.app.attachments.util.AttachmentLogger
...
class AttachmentFacade(
     ...
     *
     * 场景：KeePass / Bitwarden 条目被 COPY 到 Bastion 本地后需要把附件带过去。
     ...
     * KeePass attachment self-contained in Bastion's local encrypted store, then
