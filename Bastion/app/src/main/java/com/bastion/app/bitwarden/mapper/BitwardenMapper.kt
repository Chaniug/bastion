 ...
 * 
 * 定义 Bastion 数据模型与 Bitwarden Cipher 之间的双向映射
 */
interface BitwardenMapper<T> {
    
    /**
     * 将 Bastion 数据模型转换为 Bitwarden 创建请求
     * 
     * @param item Bastion 数据项
    ...
    /**
     * 将 Bitwarden Cipher 响应转换为 Bastion 数据模型
     * 
     * @param cipher Bitwarden Cipher 响应
     * @param vaultId Bastion 中的 Vault ID
     * @return Bastion 数据项
     */
    fun fromCipherResponse(cipher: CipherApiResponse, vaultId: Long): T
    
    /**
     * 检查 Bastion 数据项与 Bitwarden Cipher 是否有差异
     * 
     * @param item Bastion 数据项
     * @param cipher Bitwarden Cipher 响应
     * @return 是否有差异需要同步
    ...
    /**
     * 合并 Bastion 数据项和 Bitwarden Cipher
     * 用于冲突解决
     * 
     * @param local 本地 Bastion 数据
