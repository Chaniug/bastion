...
import com.bastion.app.keepass.KeePassPendingChange
import com.bastion.app.keepass.KeePassPendingChangeDao
...
abstract class PasswordDatabase : RoomDatabase() {
    ...
    companion object {
                ...
                try {
                    ...
                    database.execSQL("""
                        CREATE TABLE IF NOT EXISTS bitwarden_folders (
                            ...
                            local_bastion_category_id INTEGER,
                            sort_order INTEGER NOT NULL DEFAULT 0,
        ...
        // 对应 .kiro/specs/bastion-android-attachments Requirement 1 / 9.1
