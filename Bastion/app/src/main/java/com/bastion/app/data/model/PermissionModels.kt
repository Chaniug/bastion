...
enum class PermissionCategory(
    ...
    SECURITY(com.bastion.app.R.string.permission_category_security),      // 安全权限
    STORAGE(com.bastion.app.R.string.permission_category_storage),        // 存储权限
    NETWORK(com.bastion.app.R.string.permission_category_network),        // 网络权限
    DEVICE(com.bastion.app.R.string.permission_category_device),          // 设备权限
    LOCATION(com.bastion.app.R.string.permission_category_location)       // 位置权限
}
...
enum class PermissionImportance(
    ...
    REQUIRED(com.bastion.app.R.string.permission_importance_required),    // 必需
    RECOMMENDED(com.bastion.app.R.string.permission_importance_recommended), // 推荐
    OPTIONAL(com.bastion.app.R.string.permission_importance_optional)     // 可选
}
