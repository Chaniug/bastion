...
import com.bastion.app.utils.GoogleDriveAccountSession
import com.bastion.app.utils.GoogleDriveAuthManager
import com.bastion.app.utils.GoogleDriveAuthorizationStep
            ...
            Column(
                ...
                AnimatedVisibility(visible = useKeyFile) {
                    OutlinedTextField(
                        ...
                        trailingIcon = {
                            Row {
                                IconButton(onClick = { createKeyFileLauncher.launch("bastion.key") }) {
                                    Icon(Icons.Default.Add, contentDescription = null)
                                }
                                IconButton(onClick = { keyFilePickerLauncher.launch(arrayOf("*/*")) }) {
                                    Icon(Icons.Default.FolderOpen, contentDescription = null)
