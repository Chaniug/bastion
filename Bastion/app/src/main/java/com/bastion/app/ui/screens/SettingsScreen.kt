...
private fun getColorSchemeDisplayName(colorScheme: com.bastion.app.data.ColorScheme, context: android.content.Context): String {
    return when (colorScheme) {
        com.bastion.app.data.ColorScheme.DEFAULT -> context.getString(R.string.default_color_scheme)
        com.bastion.app.data.ColorScheme.OCEAN_BLUE -> context.getString(R.string.ocean_blue_scheme)
        com.bastion.app.data.ColorScheme.SUNSET_ORANGE -> context.getString(R.string.sunset_orange_scheme)
        com.bastion.app.data.ColorScheme.FOREST_GREEN -> context.getString(R.string.forest_green_scheme)
        com.bastion.app.data.ColorScheme.TECH_PURPLE -> context.getString(R.string.tech_purple_scheme)
        com.bastion.app.data.ColorScheme.BLACK_MAMBA -> context.getString(R.string.black_mamba_scheme)
        com.bastion.app.data.ColorScheme.GREY_STYLE -> context.getString(R.string.grey_style_scheme)
        com.bastion.app.data.ColorScheme.WATER_LILIES -> context.getString(R.string.water_lilies_scheme)
        com.bastion.app.data.ColorScheme.IMPRESSION_SUNRISE -> context.getString(R.string.impression_sunrise_scheme)
        com.bastion.app.data.ColorScheme.JAPANESE_BRIDGE -> context.getString(R.string.japanese_bridge_scheme)
        com.bastion.app.data.ColorScheme.HAYSTACKS -> context.getString(R.string.haystacks_scheme)
        com.bastion.app.data.ColorScheme.ROUEN_CATHEDRAL -> context.getString(R.string.rouen_cathedral_scheme)
        com.bastion.app.data.ColorScheme.PARLIAMENT_FOG -> context.getString(R.string.parliament_fog_scheme)
        com.bastion.app.data.ColorScheme.CATPPUCCIN_LATTE -> context.getString(R.string.catppuccin_latte_scheme)
        com.bastion.app.data.ColorScheme.CATPPUCCIN_FRAPPE -> context.getString(R.string.catppuccin_frappe_scheme)
        com.bastion.app.data.ColorScheme.CATPPUCCIN_MACCHIATO -> context.getString(R.string.catppuccin_macchiato_scheme)
        com.bastion.app.data.ColorScheme.CATPPUCCIN_MOCHA -> context.getString(R.string.catppuccin_mocha_scheme)
        com.bastion.app.data.ColorScheme.CUSTOM -> context.getString(R.string.custom_color_scheme)
    }
}

private fun getProgressBarStyleDisplayName(style: com.bastion.app.data.ProgressBarStyle, context: android.content.Context): String {
    return when (style) {
        com.bastion.app.data.ProgressBarStyle.LINEAR -> context.getString(R.string.progress_bar_style_linear)
        com.bastion.app.data.ProgressBarStyle.WAVE -> context.getString(R.string.progress_bar_style_wave)
    }
}
