...
import com.bastion.app.ui.components.SshKeyGenerationProgressIndicator
...
import com.bastion.app.utils.SshKeyGenerator
    ...
    fun generateNewKey() {
        ...
        scope.launch {
            ...
            val generated = withContext(Dispatchers.Default) {
                runCatchingObserved { SshKeyGenerator.generate(request, comment) }
            }
            isGenerating = false
