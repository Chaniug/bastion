...
/**
 * Bastion Credential Provider Service
 * 
...
class BastionCredentialProviderService : CredentialProviderService() {
    
    companion object {
        private const val TAG = "BastionCredentialProvider"
        ...
        try {
            ...
            for (passkey in filteredPasskeys) {
                ...
                passkey.displayTitle(),
                    ...
                    .setIcon(android.graphics.drawable.Icon.createWithResource(this, com.bastion.app.R.drawable.ic_passkey))
                    .build()
    ...
    private fun isUsablePasskey(passkey: com.bastion.app.data.PasskeyEntry): Boolean {
    ...
    ): List<com.bastion.app.data.PasskeyEntry> {
    ...
    private fun buildGetCredentialIntentAction(passkey: com.bastion.app.data.PasskeyEntry): String {
    ...
    private fun buildGetCredentialRequestCode(passkey: com.bastion.app.data.PasskeyEntry): Int {
        return buildString {
            append("get:")
            append(passkey.id)
            append(':')
