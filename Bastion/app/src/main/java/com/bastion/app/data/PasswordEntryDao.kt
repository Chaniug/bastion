...
interface PasswordEntryDao {
    ...
    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getAllPasswordEntriesListItem(): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND categoryId = :categoryId ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getPasswordEntriesByCategoryListItem(categoryId: Long): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND categoryId IS NULL ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getUncategorizedPasswordEntriesListItem(): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND keepassDatabaseId = :databaseId ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getPasswordEntriesByKeePassDatabaseListItem(databaseId: Long): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND keepassDatabaseId = :databaseId AND keepassGroupPath = :groupPath ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getPasswordEntriesByKeePassGroupListItem(databaseId: Long, groupPath: String): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND keepassDatabaseId IS NULL ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun getPasswordEntriesWithoutKeePassDatabaseListItem(): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND isFavorite = 1 ORDER BY sortOrder ASC, updatedAt DESC")
    fun getFavoritePasswordEntriesListItem(): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND (title LIKE '%' || :query || '%' OR website LIKE '%' || :query || '%' OR username LIKE '%' || :query || '%' OR appName LIKE '%' || :query || '%' OR appPackageName LIKE '%' || :query || '%') ORDER BY isFavorite DESC, sortOrder ASC, updatedAt DESC")
    fun searchPasswordEntriesListItem(query: String): Flow<List<PasswordEntryListItem>>

    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 1 ORDER BY deletedAt DESC")
    ...
    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 1 ORDER BY archivedAt DESC, updatedAt DESC")
    fun getArchivedEntriesListItem(): Flow<List<PasswordEntryListItem>>

    // C.3.3 选项 A：Bitwarden Vault / Folder 列表投影（列表流也会按 vault/folder 浏览）
    @Query("SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId FROM password_entries WHERE isDeleted = 0 AND isArchived = 0 AND bitwarden_vault_id = :vaultId ORDER BY title ASC")
    fun getPasswordEntriesByBitwardenVaultListItem(vaultId: Long): Flow<List<PasswordEntryListItem>>

    @Query("""
        SELECT id, title, website, username, notes, updatedAt, createdAt, isFavorite, isGroupCover, appPackageName, appName, categoryId, keepassDatabaseId, authenticatorKey, loginType, ssoProvider, customIconType, customIconValue, bitwarden_vault_id AS bitwardenVaultId, bitwarden_local_modified AS bitwardenLocalModified, isDeleted, isArchived, sortOrder, password, bitwarden_folder_id AS bitwardenFolderId, keepassGroupPath, keepass_entry_uuid AS keepassEntryUuid, bitwarden_cipher_id AS bitwardenCipherId
        ...
        ORDER BY title ASC
    """)
    fun getPasswordEntriesByBitwardenFolderListItem(vaultId: Long, folderId: String): Flow<List<PasswordEntryListItem>>
