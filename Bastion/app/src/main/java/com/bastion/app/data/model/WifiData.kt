 ...
 * WIFI 条目扩展元数据。
 *
 * 复用 [com.bastion.app.data.PasswordEntry]：
 *   - [com.bastion.app.data.PasswordEntry.title]      -> 条目显示标题（通常就是 SSID）
 *   - [com.bastion.app.data.PasswordEntry.password]   -> WPA/WEP/企业级 口令或凭据密码
 *   - [com.bastion.app.data.PasswordEntry.username]   -> 企业级 WIFI 的身份（Identity）
 *   - [com.bastion.app.data.PasswordEntry.loginType]  -> 取值 "WIFI"
 *   - [com.bastion.app.data.PasswordEntry.wifiMetadata] -> 本对象的 JSON 序列化
 *
