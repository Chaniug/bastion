    ...
    suspend fun applyRestoreResult(
        ...
        if (content.portableAttachments.isNotEmpty) {
            ...
            content.portableAttachments.entries.forEach { entry ->
                ...
                try {
                    val attachment = com.bastion.app.attachments.backup.PortableAttachmentBackup
            ...
            content.attachments.forEach { entry ->
                ...
                val attachment = with(
                    com.bastion.app.attachments.backup.AttachmentBackupCodec
        ...
        secureItems.forEach { exportItem ->
            try {
                ...
                if (existingItem == null) {
                        ...
                        try {
                            ...
                            if (totpData.boundPasswordId != null && totpData.boundPasswordId > 0) {
                                ...
                                if (newBoundId != null) {
                                    ...
                                    finalItemData = if (securityManager.looksLikeBastionCiphertext(exportItem.itemData)) {
                    ...
                    val secureItem = com.bastion.app.data.SecureItem(
                        id = 0,
                        itemType = itemType,
