# Bastion 自动填充 v2.0 发布说明

## 🎉 重大更新

Bastion 密码管理器 v2.0 带来了全面升级的自动填充功能，显著提升了可靠性、准确性和用户体验。
...
- 🐛 [GitHub Issues](https://github.com/bastion/bastion-android/issues)
...
Bastion 密码管理器是开源软件，采用 MIT License。
