...
# 监控所有关键日志
adb logcat | Select-String "AutofillPicker|BastionAutofill|SaveInfo"
```
...
SaveInfoDiag: 📝 Description: 保存到 Bastion 密码管理器
SaveInfoDiag: ╚════════════════════════════════════════╝
```
...
```
BastionAutofill: ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
BastionAutofill: 💾💾💾 onSaveRequest TRIGGERED! 💾💾💾
BastionAutofill: ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
如果前5个条件都满足,但第8个不满足,问题在于**测试应用的表单提交逻辑**,不是 Bastion 的问题。
