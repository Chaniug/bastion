...
**期望输出**:
```
com.bastion.app/.autofill.BastionAutofillService
```
...
2. [系统] 调用 onFillRequest
   ↓
3. [Bastion] 解析字段,创建 FillResponse + SaveInfo
   ↓
4. [系统] 显示自动填充建议
   ↓
