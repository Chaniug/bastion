...
本文记录 Bastion 接入 MDBX 1.0 的当前边界、自动化证据和必须真机验证的项目。
...
```powershell
.\gradlew.bat :app:testDebugUnitTest --tests com.bastion.app.repository.MdbxAndroidIntegrationGuardTest
.\gradlew.bat :app:compileDebugKotlin
.\gradlew.bat :app:assembleDebugAndroidTest
git diff --check -- "Bastion/app/src/main/java/com/bastion/app" "Bastion/app/src/main/res" "Bastion/app/src/test/java/com/bastion/app/repository/MdbxAndroidIntegrationGuardTest.kt"
```

已在 `Pixel_Fold_API_35` 模拟器上通过：

```powershell
& 'D:\AndroidSDK\platform-tools\adb.exe' -s emulator-5554 shell am instrument -w -r -e class com.bastion.app.repository.MdbxVaultStoreInstrumentedCompatibilityTest com.bastion.app.test/androidx.test.runner.AndroidJUnitRunner
```
