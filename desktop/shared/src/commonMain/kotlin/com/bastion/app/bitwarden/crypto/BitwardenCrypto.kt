...
object BitwardenCrypto {
    ...
    fun deriveMasterPasswordHash(
        ...
        val result = Base64.encodeToString(hash)
    ...
    fun encrypt(plaintext: ByteArray, key: SymmetricCryptoKey): String {
        ...
        // 构建 CipherString
        val ivBase64 = Base64.encodeToString(iv)
        val dataBase64 = Base64.encodeToString(encrypted)
        val macBase64 = Base64.encodeToString(mac)
