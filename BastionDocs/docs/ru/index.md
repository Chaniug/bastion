...
hero:
  ...
  tagline: "Bastion — это локальный менеджер паролей с открытым исходным кодом. Управляйте своими паролями, кодами 2FA и зашифрованными заметками. Все данные хранятся исключительно на вашем локальном устройстве, минуя любые облака."
  image:
    src: /themepng.png
    alt: Иконка приложения Bastion
  actions:
    - theme: brand
