...
const localeText = {
  zh: {
    title: "GitHub 提交",
    fallbackDescription: "Bastion/Bastion 的提交活跃度",
  ...
  en: {
    ...
    fallbackDescription: "Commit activity for Bastion/Bastion",
  ...
  ja: {
    title: "GitHub コミット",
    fallbackDescription: "Bastion/Bastion のコミットアクティビティ",
  ...
  vi: {
    title: "Commit GitHub",
    fallbackDescription: "Hoạt động commit của Bastion/Bastion",
  ...
  ru: {
    ...
    fallbackDescription: "Активность коммитов Bastion/Bastion",
