  ...
  [localizedPath(locale, "reference/")]: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: text.cli, link: localizedPath(locale, "reference/bastion-pass-cli-development") },
      ],
    },
  ],
});
