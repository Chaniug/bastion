...
Bastion bao gồm 7 màn hình chính, có thể truy cập thông qua thanh điều hướng phía dưới:
...
Bastion hỗ trợ tùy biến sâu giao diện. Bạn có thể chuyển đổi giữa chế độ sáng/tối, cấu hình các gói ngôn ngữ (bao gồm cả tiếng bản địa) và chọn các chủ đề màu sắc cá nhân hóa cho ứng dụng.

![Cài đặt giao diện và chủ đề](/image/language_dark_mode.jpg)

> [!IMPORTANT]
> **Ưu tiên màu động hệ thống**
> Nếu hệ thống đang bật tính năng trích xuất màu từ hình nền (Material You), các bảng màu tùy chỉnh của ứng dụng sẽ tạm thời không được áp dụng. Để thiết lập bảng màu thủ công, vui lòng tắt tính năng trích xuất màu động trong cài đặt của Bastion trước.

### Cơ chế Bastion Plus

Bastion Plus **không phải** là một phiên bản mở rộng tính năng trả phí hay gói đăng ký bắt buộc. Đây hoàn toàn là một cơ chế quyên góp tự nguyện (donate) dựa trên nguyên tắc trung thực. Nếu bạn thấy dự án hữu ích, bạn có thể kích hoạt trạng thái Plus chỉ với một cú nhấp chuột mà không tốn bất kỳ chi phí thực tế nào. Ứng dụng vẫn hoàn toàn miễn phí!
...
* **Chống ảnh chụp màn hình**: Khi kích hoạt tùy chọn này, hệ thống sẽ chặn việc chụp màn hình hoặc ghi màn hình bên trong giao diện Bastion, đảm bảo tính riêng tư tối đa cho dữ liệu trên thiết bị.
...
Ngoài định dạng nội bộ, ứng dụng hỗ trợ xuất dữ liệu theo cấu trúc tiêu chuẩn của KeePass hoặc sơ đồ của Aegis Authenticator. Điều này giúp bạn dễ dàng di chuyển dữ liệu sang phần mềm khác nếu thấy Bastion không còn phù hợp với nhu cầu của mình.

Tích hợp WebDAV hỗ trợ cả sao lưu các tệp lưu trữ tiêu chuẩn của Bastion lẫn đồng bộ hóa tương thích với KeePass. Bản thực thi này mang khả năng hỗ trợ gốc cho các tệp `.kdbx` trực tiếp vào hệ sinh thái của Bastion! Bước tiếp theo trong kế hoạch phát triển (roadmap) của chúng tôi là triển khai cơ chế nhân bản tương thích với Bitwarden, vì tôi muốn công cụ này luôn cực kỳ mạnh mẽ, linh hoạt và đa năng cho mọi người dùng.
