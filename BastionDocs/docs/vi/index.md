...
hero:
  ...
  tagline: "Bastion là một trình quản lý mật khẩu cục bộ mã nguồn mở. Quản lý mật khẩu, mã xác thực 2FA và ghi chú mã hóa của bạn, tất cả dữ liệu được lưu trữ hoàn toàn trên thiết bị cục bộ và không đi qua bất kỳ đám mây nào."
  image:
    src: /themepng.png
    alt: Biểu tượng ứng dụng Bastion
  actions:
    - theme: brand
