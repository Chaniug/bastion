...
Bastion features 7 main screens accessible via the bottom navigation bar:
...
Now, let's explore Bastion's configuration dashboards.

## Aesthetic Theme Engine

The UI is built entirely on Material 3 (M3) design principles. While it natively samples dynamic accents directly from your system wallpaper, Bastion also bundles three distinct preset theme categories:
...
Bastion Plus is an honor-system contribution option; it is **not** a paywall, nor does it gate software features. If you are not in a position to tip, you can tap the unlock button to activate everything for free. Enjoy it without worries!
...
Turning on "Screen Capture Protection" prevents screenshots or screen recordings anywhere inside Bastion, keeping your credentials hidden from background malware.
...
Exporting formats include standard KeePass structures or Aegis Authenticator schemas, making it easy to transition your data to other software if Bastion doesn't suit your needs.

WebDAV operations support standard Bastion file backups or KeePass-compatible synchronizations. This implementation brings native KeePass file compatibility directly into Bastion! Bitwarden-compatible replication is next on our roadmap, as I want this tool to remain incredibly powerful and versatile for everyone.
