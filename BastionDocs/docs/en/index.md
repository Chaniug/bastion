...
hero:
  ...
  tagline: "Bastion is an open-source local password manager. Manage passwords, 2FA, and secure notes with all data stored entirely on your local device."
  image:
    src: /themepng.png
    alt: Bastion App Icon
  actions:
    - theme: brand
