...
const repoOwner = process.env.GITHUB_COMMITS_REPO_OWNER || "Bastion";
const repoName = process.env.GITHUB_COMMITS_REPO_NAME || "Bastion";
...
const headers = {
  ...
  "User-Agent": "BastionDocs-GitHub-Commits-Updater",
